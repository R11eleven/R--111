...
## 当按钮和滑条被悬停时使用的颜色。
define gui.hover_color = '#7c7c7c'

## 当文本按钮被选中但非焦点时使用的颜色。当一个按钮为当前屏幕或设置选项值时，会
## 处于选中状态。
define gui.selected_color = '#8f8f8f'
...
## 游戏内文本使用的字体。
define gui.text_font = "SkyHeartClearSerifSC（简体版）-Regular.ttf"

## 角色名称使用的字体。
define gui.name_text_font = "SkyHeartClearSerifSC（简体版）-Regular.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "SkyHeartClearSerifSC（简体版）-Regular.ttf"
...
## 游戏用户界面中文本的大小。
define gui.interface_text_size = 120
...
## 人物详情页左侧导航菜单字体大小
define gui.character_detail_nav_text_size = 120

## 人物详情页右侧内容字体大小
define gui.character_detail_content_text_size = 40
...
style character_card_value:
    size 100
    color "#4a86e8"
    xalign 0.5

style character_card_locked:
    size 80
    color "#666666"
    xalign 0.5

style character_card_hint:
    size 80
    color "#555555"
    xalign 0.5
...
style filter_button_text:
    ...
    insensitive_color "#666666"  # 未激活时的颜色
    xalign 0.5
...
## 标题菜单和游戏菜单使用的图像。
define gui.main_menu_background = Movie(play="videos/menu.webm", size=(3840, 2160))
define gui.game_menu_background = Movie(play="videos/menu.webm", size=(3840, 2160))
...
## 导航按钮左侧相对于屏幕左侧的位置。
define gui.navigation_xpos = 250
